...
public class Matrix {
    ...
    public Matrix multiply(double number) {
        ...
        for (var i = 0; i < rows; i++)
            for (var j = 0; j < columns; j++) result[i][j] = matrix[i][j] * number;
    ...
    public Matrix multiply(Matrix mtr) {
        ...
        for (var i = 0; i < aRows; i++)
            for (var j = 0; j < bColumns; j++)
                for (var k = 0; k < aColumns; k++) product[i][j] += matrix[i][k] * mtr.getMatrix()[k][j];
    ...
    public Matrix addMatrix(Matrix mtr) {
        ...
        for (var i = 0; i < rows; i++)
            for (var j = 0; j < columns; j++) sum[i][j] = matrix[i][j] + mtr.getMatrix()[i][j];
